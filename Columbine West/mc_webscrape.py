...
def webscrape(username, password):
    ...
    facility_elem.send_keys('Columbine')

    search_elem = browser.find_element_by_name('search')
    search_elem.click() # Executes the search

    facility_elem = browser.find_element_by_link_text('COLUMBINE WEST HEALTH & REHAB - Fort Collins, CO')
    facility_elem.click()
    ...
    xl.Workbooks.Open(Filename="G:/Therapy Record Interfaces/Columbine West/Columbine West Therapy Record Interface.xlsm")
