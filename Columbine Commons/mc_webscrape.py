...
def webscrape(username, password):
    ...
    facility_elem = browser.find_element_by_link_text('COLUMBINE COMMONS HEALTH & REHAB - CO')
    facility_elem.click()
    ...
    xl.Workbooks.Open(Filename="G:/Therapy Record Interfaces/Columbine Commons/Columbine Commons Therapy Record Interface.xlsm")
